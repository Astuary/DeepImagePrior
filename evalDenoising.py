...
noisy_img = torch.FloatTensor(noise1).unsqueeze(0).transpose(1,3)#.unsqueeze(0).transpose(2, 3)
clean_img = torch.FloatTensor(im).unsqueeze(0).transpose(1,3)#.unsqueeze(0).transpose(2,3)
